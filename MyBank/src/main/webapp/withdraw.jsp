...
<input type="number" required name="withdraw" id="withdraw" placeholder="$0.00">

<input type="submit" value="withdraw" name="submit" id=submit>
...
{
	out.print(session.getAttribute("withdraw"));
